...
class PrintButton(wx.BitmapButton):
	def __init__(self, images):
		...
		wx.BitmapButton.__init__(self, wx.ID_ANY, self.imgPrint, size=BUTTONDIM)
		self.setPrint()
...
class PauseButton(wx.BitmapButton):
	def __init__(self, images):
		wx.BitmapButton.__init__(self, wx.ID_ANY, images.pngPause, size=BUTTONDIM)
		self.setPause()
...
class PrintMonitorDlg:
	def __init__(self, parent, prtName):
		...
		self.bImport = wx.BitmapButton(self, wx.ID_ANY, self.settings.pngImport, size=BUTTONDIM)
		self.bImport.SetToolTipString("Import G Code file from toolbox")
		
		self.bOpen = wx.BitmapButton(self, wx.ID_ANY, self.settings.pngFileopen, size=BUTTONDIM)
		self.bOpen.SetToolTipString("Open a G Code file")
		self.Bind(wx.EVT_CLOSE, self.onClose)
		
		self.bPrint = PrintButton(self.images)
		self.bPrint.Enable(False)
		
		self.bPause = PauseButton(self.images)
